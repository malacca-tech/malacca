...
public class OhMyEmail {
     ...
     */
    public static OhMyEmail subject(String subject) throws EmailMessageHandlerException {
        OhMyEmail ohMyEmail = new OhMyEmail();
        ohMyEmail.msg = new MimeMessage(session);
        try {
            ohMyEmail.msg.setSubject(subject, "UTF-8");
        } catch (Exception e) {
            throw new EmailMessageHandlerException(e);
        }
        return ohMyEmail;
    }
     ...
     */
    public OhMyEmail from(String nickName) throws EmailMessageHandlerException {
     ...
     */
    public OhMyEmail from(String nickName, String from) throws EmailMessageHandlerException {
        try {
    ...
    public OhMyEmail replyTo(String... replyTo) throws EmailMessageHandlerException {
    ...
    public OhMyEmail to(String... to) throws EmailMessageHandlerException {
        try {
    ...
    public OhMyEmail cc(String... cc) throws EmailMessageHandlerException {
        try {
    ...
    public OhMyEmail bcc(String... bcc) throws EmailMessageHandlerException {
        try {
    ...
    public OhMyEmail attach(File file) throws EmailMessageHandlerException {
        attachments.add(createAttachment(file, null));
        return this;
    }

    public OhMyEmail attach(File file, String fileName) throws EmailMessageHandlerException {
        attachments.add(createAttachment(file, fileName));
        return this;
    }

    public OhMyEmail attachURL(URL url, String fileName) throws EmailMessageHandlerException {
        attachments.add(createURLAttachment(url, fileName));
        return this;
    }

    private MimeBodyPart createAttachment(File file, String fileName) throws EmailMessageHandlerException {
    ...
    private MimeBodyPart createURLAttachment(URL url, String fileName) throws EmailMessageHandlerException {
        MimeBodyPart attachmentPart = new MimeBodyPart();
    ...
    public void send() throws EmailMessageHandlerException {
